# KAMA 9/21 Crossover Strategy with Price > 200 KAMA Filter and Fixed Stop Loss
# KAMA(9) vs KAMA(21) crossover with price above 200-period KAMA trend filter
...
class KAMA1355Filter(Strategy):
    """
    KAMA 9/21 Crossover Strategy with Trend Filter and Fixed Stop Loss.

    Uses three KAMAs:
    - Fast KAMA (len_fast=9): Short to medium-term trend
    - Slow KAMA (len_slow=21): Baseline trend direction
    ...
    All KAMAs use same fast_end/slow_end parameters (Kaufman 2-30).
    Only the lookback period differs (9, 21, 200).
    """
